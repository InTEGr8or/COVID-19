...
if ($pull_result -ne "Already up to date." -or $Force){
    ...
    pageres 'https://www.worldometers.info/coronavirus/' 1180x1500 --selector='body > div.container > div:nth-child(2) > div.col-md-8 > div > div:nth-child(14)' --filename='content/worldometers_coronavirus' --crop --overwrite
